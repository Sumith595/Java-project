...
public class Quiz extends JFrame implements ActionListener{
    ...
    Quiz(String name){
        ...
        img.setBounds(0,0,1300,345);
        add(img); 
        
        qno = new JLabel("1");
        qno.setBounds(80,400,50,30);
        qno.setFont(new Font("Times Now Roman",Font.BOLD,24));
        add(qno);
        
        question = new JLabel("This is new question");
        question.setBounds(130,400,800,30);
        question.setFont(new  Font("Times Now Roman",Font.PLAIN,22));
        add(question);
        ...
        button.setBounds(1000,500,200,40);
